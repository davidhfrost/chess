...
public interface ChessGame {
  ...
  /**
   * Returns the number of rows needed for this type of chess
   * @return the number of rows for this game
   */
  public int getNumRows();

  /**
   * Return the number of columns needed for this type of chess
   * @return the number of columns for this game
   */
  public int getNumColumns();

  /**
   * Initializes the board and places all of the piece onto the board and then starts a game of chess
