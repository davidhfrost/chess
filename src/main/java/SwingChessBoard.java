...
/**
 * <p>Creates a SwingChessBoard in a window on the desktop.  The SwingChessBoard has a SwingChessBoardDisplay object that determines
 * how the individual squares of the SwingChessBoard should be drawn.</p>
 *
 * <p>The SwingChessBoard uses a ChessGame object to determine how the game should be played.  The way the SwingChessBoard works
 * is as follows.  The player selects a piece by clicking on the board, and
 * and the SwingChessBoard calls the <tt>legalPieceToPlay</tt> method of the ChessGame object.
 * If the player is allowed to select the piece, the board highlights it, and the player can select another square on
 * the board.  The SwingChessBoard then calls the <tt>makeMove</tt> method of the ChessGame object.  The ChessGame is
 * responsible for determining if the move is valid, and if it is to update the game and the SwingChessBoard
...
public class SwingChessBoard implements ChessBoard {
     ...
     * @param numRows   the number of rows for the SwingChessBoard
     * @param numColumns  the number of columns for the SwingChessBoard
     * @param boardDisplay  an object that determines how the squares on the SwingChessBoard should be drawn
